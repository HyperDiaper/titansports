    ...
    <>
      <section className="relative pt-36 pb-20 px-6 overflow-hidden" style={{ background: '#0d1a0d' }}>
        <div className="absolute inset-0">
          <img src="/images/turf-aerial.png" alt="Book" className="w-full h-full object-cover scale-[1.15]" style={{ objectPosition: 'center 55%' }} />
          <div className="absolute inset-0" style={{ background: 'linear-gradient(to bottom, rgba(13,26,13,0.15), rgba(13,26,13,0.65))' }} />
        </div>
      ...
      <section className="py-20 px-6" style={{ background: 'var(--titan-cream)' }}>
